<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AdminMemberManagement.aspx.cs" Inherits="BugTracker.AdminMemberManagement" %>
        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <div class="row">
                    <div class="col">
                        <center>
                            <img width="100" src="img/member.png" />
                        </center>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label>Accound Status</label>
                        <div class="form-group">
                            <div class="input-group">
                                <asp:TextBox CssClass="form-control me-1" ID="TextBox3" runat="server" placeholder="Account Status" ReadOnly="True"></asp:TextBox>
                                <asp:LinkButton class="btn btn-success me-1" ID="LinkButton2" runat="server"><i class="fas fa-check-circle"></i></asp:LinkButton>
                                <asp:LinkButton class="btn btn-warning me-1" ID="LinkButton3" runat="server"><i class="far fa-pause-circle"></i></asp:LinkButton>
                                <asp:LinkButton class="btn btn-danger" ID="LinkButton4" runat="server"><i class ="fas fa-times-circle"></i></asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-8 mx-auto">
                        <asp:Button class="btn btn-lg w-100 btn-danger" ID="Button1" runat="server" Text="Delete Employee Permanently" />
                    </div>
                </div>
